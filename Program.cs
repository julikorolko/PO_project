...
namespace ProjektPO
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Offer o4 = new Offer("Egypt - Dahab", "Kraków", "Happy Life Village", 10, 2100, "20-02-2021", "30-02-2021");
             
            Offer o5 = new Offer("Egypt - Hurghada", "Kraków", "Long Beach Resort", 7, 1500, "22-02-2021", "29-02-2021");

            Offer o6 = new Offer("Cyprus - Paphos", "Kraków", "Coral View", 7, 1000, "23-02-2021", "30-02-2021");

            Offer o7 = new Offer("Cyprus - Limassol", "Kraków", "Kapetanios", 6, 1400, "24-02-2021", "30-02-2021");
            ...
            Offer o12 = new Offer("Dominican Republic - Maimon", "Kraków", "Riu Bachata", 7, 5100, "09-04-2021", "16-04-2021");

            Offer o13 = new Offer("Dominican Republic - Puerto Plata", "Kraków", "Iberostar", 7, 7200, "09-04-2021", "16-04-2021");
           ...
           Console.WriteLine(offers_list.ToString());
            ...
            OffersList.ZapiszXML("offerslist.xml", offers_list);
            OffersList offers_list2 = OffersList.OdczytajXML("offerslist.xml");
